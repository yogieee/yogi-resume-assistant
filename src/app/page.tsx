...
export default function Home() {
  ...
  return (
    <main className="h-dvh max-h-dvh flex flex-col overflow-hidden bg-topological isolate">
      {/* Top bar: Name & Role */}
      <header className="shrink-0 px-4 py-2 border-b border-console-border/50 bg-black/40 backdrop-blur-sm relative z-10">
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-[600px_1fr] gap-0 min-h-0 relative z-10">
        {/* Left: Interactive 3D Badge */}
        <div className="relative flex flex-col border-r border-console-border/50 min-h-0 h-full overflow-hidden">
          <BadgeLoader />
        ...
        <div className="flex flex-col min-h-0 h-full">
          <div className="shrink-0 px-4 py-2 border-b border-console-border/30 bg-console-surface/50">
      ...
      <footer className="shrink-0 px-4 py-1 border-t border-console-border/50 relative z-10">
        <ProfileActions />
      </footer>
    </main>
  );
